...
const CTA = () => (
  ...
  <div id="contact-us" className="relative isolate bg-black">
      ...
      <div className="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
        <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-300">
            Reach out to us to learn more about our products, services, and careers. We're always happy to help!
          </p>
            ...
            <div className="flex gap-x-4">
              ...
              <dd>
                <a className="hover:text-white" href="mailto:hello@example.com">
                  recruiter@metresaitsolutions.tech
                </a>
              </dd>
            </div>
          </dl>
            ...
            <div>
              ...
              <div className="mt-2.5">
                <input
                  ...
                  className="block w-full rounded-md border-0 bg-white/5 px-3.5 py-2 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-cyan-500 sm:text-sm sm:leading-6"
                />
              </div>
            </div>
            <div>
            ...
            <div className="sm:col-span-2">
              ...
              <div className="mt-2.5">
                <textarea
                  ...
                  rows={4}
                  className="block w-full rounded-md border-0 bg-white/5 px-3.5 py-2 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-cyan-500 sm:text-sm sm:leading-6"
                  defaultValue={'Inquiry: Demo / Pricing / Internship / Other\n\nMessage:\n'}
                />
              </div>
            </div>
          </div>
